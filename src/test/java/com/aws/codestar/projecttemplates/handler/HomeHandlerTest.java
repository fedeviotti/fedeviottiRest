...
@DisplayName("Tests for HomeHandler")
public class HomeHandlerTest {
	
	private static final String EXPECTED_CONTENT_TYPE = "application/json";
    private static final String EXPECTED_RESPONSE_VALUE = "Hello Federico!";
    ...
    void testHandleRequest() {
        GatewayResponse response = (GatewayResponse) new HomeHandler().handleRequest(input, mockLambdaContext);
